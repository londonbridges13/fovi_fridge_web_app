class FoodItemsController < ApplicationController
  ...
  # GET /food_items.json
  def index
    @food_items = current_user.family.fridge.food_items.all #FoodItem.all
  end
  ...
  # GET /food_items/new
  def new
    @food_item = current_user.family.fridge.food_items.build #FoodItem.new
  end
  ...
  def create
    @food_item = current_user.family.fridge.food_items.build(food_item_params)
  ...
  private
    ...
    def food_item_params
      params.require(:food_item).permit(:title)
    end
end
